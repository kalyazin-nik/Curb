using System.Text;
using Curb.API.ComponentRegistrar;
...
internal class Program
{
    internal static void Main(string[] args)
    {
        ...
        builder.Services.AddDbContext<CurbDbContext>(options => options.UseNpgsql(builder.Configuration.GetConnectionString("PostgresConnection")));
